note
	description: "Total order relation on key-value pairs derived from a total order relation on keys."
...
class
	V_KEY_VALUE_ORDER [K, V]

inherit
	V_TOTAL_ORDER [TUPLE [key: K; value: V]]
...
feature -- Basic operations
	greater_equal (x, y: TUPLE [key: K; value: V]): BOOLEAN
			-- Is `x' >= `y'?
		do
...
feature -- Specification
	key_order_relation: MML_ENDORELATION [K]
