...
--			end
--		ensure
--			index_effect_not_found: not sequence.tail (old index).has (v) implies index = 0
...
--			end
--		ensure
--			index_effect_not_found: not sequence.tail (old index).range.exists (pred) implies index = 0
